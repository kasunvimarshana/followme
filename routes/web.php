...
Route::group(['middleware' => 'memberMiddleWare'], function(){
    ...
    Route::get('home/direct-reports/show-all', array('uses' => 'UserController@showDirectReports'))->name('user.showDirectReports');
    Route::get('home/direct-reports/{user}/show-tws', array('uses' => 'UserController@showDirectReportTW'))->name('directReport.showDirectReportTW');
