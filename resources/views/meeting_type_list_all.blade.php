    ...
    <div class="col-sm-12">
        ...
        <div class="panel-group" id="accordion">
            ...
            <div id="collapseOneParent" class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#collapseOneParent" href="#collapseOne"><span class="glyphicon glyphicon-plus"></span> Search Meeting Type</a>
                    </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse out">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <!-- form -->
                                <form action="#" method="GET" class="col-sm-8" autocomplete="off" id="searchForm">
                                    @csrf
                                    <!-- form-group -->
            ...
            <div id="collapseTwoParent" class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#collapseTwoParent" href="#collapseTwo"><span class="glyphicon glyphicon-plus"></span> Meeting Types</a>
                    </h4>
                </div>
                <div id="collapseTwo" class="panel-collapse collapse in">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <!-- table -->
                                <table id="meetingTypeDataTable" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%"></table>
                                <!-- /.table -->
                            </div>
                            <!-- /.col -->
                        </div>
...
@section('section_script')
    ...
    @includeIf('partials.meeting_type_data_table')
    <script>
        $(function(){
            var searchForm = $('#searchForm');
            searchForm.submit(function(event){
                event.preventDefault();
                var departmentDataTable = $('#meetingTypeDataTable').DataTable();
