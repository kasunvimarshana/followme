                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <!-- form -->
                                <form action="{!! route('tw.update', ['tW' => $tW->id]) !!}" method="POST" class="col-sm-8" autocomplete="off" id="twForm" enctype="multipart/form-data">
                                    @csrf
                                    <!-- form-group -->
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-10">
                                            <!-- p class="form-control-static"></p -->
                                            <input type="text" class="form-control" id="title" name="title" placeholder="3W" value="{{ $tW->title }}" required readonly/>
                                        </div>
                                        <!-- span id="form-control" class="help-block"></span -->
                                    </div>
                                    <!-- /.form-group -->
